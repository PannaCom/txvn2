...
#define CAR_TYPE_FILTER @[@"Xe taxi", @"Xe tải", @"Xe Container", @""]
...
//
//// RegisterView
//#define REGISTER_TITLE_EDIT @"Sửa thông tin"
//#define REGISTER_SAVE_BUTTON @"Lưu"
//#define REGISTER_CAR_SIZE @"%@ chỗ"
//#define REGISTER_CAR_PRICE_CUSTOM @"Tự thỏa thuận"
//#define REGISTER_ERROR @"Đăng ký không thành công"
//#define REGISTER_TITLE_SELECT_CAR_MADE @"Chọn hãng xe"
//#define REGISTER_TITLE_SELECT_CAR_TYPE @"Chọn loại xe"
//#define REGISTER_TITLE_SELECT_CAR_SIZE @"Chọn số chỗ"
//#define REGISTER_TITLE_SELECT_CAR_YEAR @"Chọn năm sản xuất xe"
//#define REGISTER_TITLE_SELECT_CAR_PRICE @"Chọn mức giá (đồng/km)"
//
//// Active View
//#define ACTIVE_ERROR_TITLE @"Lỗi"
//#define ACTIVE_ERROR_INPUT @"Hãy nhập đủ 5 số"
//#define ACTIVE_ERROR_ACTIVE_FAIL @"Hãy kiểm tra lại mã xác nhận"
//
//// Driver Map
//#define MAP_CURRENT_LOCATION @"Vị trí hiện tại"
//#define CHANGE_USER @"Đổi vai trò"
//#define CANCEL @"Hủy"
//
//// Filter View
//#define FILTER_LOADING @"Đang tải dữ liệu"
//
//// Listdata View
//#define LISTDATA_EMTY @"Chưa tìm được xe nào"
//#define PULL_TO_REFRESH @"Kéo để cập nhật"
//#define RELEASE_TO_REFRESH @"Thả ra để cập nhật"
//#define PULL_TO_REFRESH_LOADING @"Đang cập nhật" 
//// -------------
